...
export const GetCertificate = () => {
  ...
  const zora = async () => {
    const fetchAgent = new Strategies.ZDKFetchStrategy(Networks.MUMBAI);
  ...
  const createCertificate = async () => {
    ...
    const tokenUri =
      'https://ipfs.io/ipfs/bafkreieokh3pwl6h2ydnjv3a2cl7aqxed5gfxp6mto74i4p53xminikfyu';
    if (maticAmount < 100) {
      setIsLoading(false);
          ...
          <Row justify="center" align="center" css={{ m: '10px 0 0 0' }}>
            {isConnected && address ? (
              ...
              <>
                ...
                {/* <ConnectButton /> */}
                <Button disabled>Get Certificate</Button>
              </>
            )}
          </Row>
        </>
